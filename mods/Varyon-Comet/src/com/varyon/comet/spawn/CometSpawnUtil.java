...
import com.varyon.comet.wave.CometWaveManager;
...
public final class CometSpawnUtil {
    ...
    public static BlockType resolveCometSpawnBlockType(String preferredId, String tierDefaultId, java.util.function.Consumer<String> onFallback) {
        ...
        if (onFallback != null && preferredId != null && !preferredId.equals(tierDefaultId)) {
            onFallback.accept("Preferred block '" + preferredId + "' not found (tried path variants and map scan); trying tier default.");
        }
    ...
    public static String getExplosionParticleSystemForPlacedBlock(CometTier tier) {
     ...
     *
     * @return The placed block's ID (e.g. "Comet_Stone_Common") on success, or null on failure
     */
    @Nullable
     ...
     * for any block whose getId() equals or ends with the preferred id (e.g. path-prefixed ids).
     */
    @Nullable
