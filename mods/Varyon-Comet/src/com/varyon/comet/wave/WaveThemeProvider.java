...
public class WaveThemeProvider {
    ...
    public static String selectThemeIdForWave(
            Vector3i blockPos,
            CometTier tier,
            Map<Vector3i, String> forcedThemes,
            Logger logger) {
        if (forcedThemes.containsKey(blockPos)) {
            String id = forcedThemes.remove(blockPos);
            if (id != null && !id.isBlank()) {
                logger.info("Forced theme at " + blockPos + ": " + getThemeName(id));
                return id;
            }
        }
        return selectTheme(tier);
    }
    ...
    public static String selectTheme(CometTier tier) {
        ...
        String id = config.pickThemeByWeight(tierNum, RANDOM);
        if (id == null) {
            LOGGER.warning("No theme for tier " + tier.getName());
            return null;
        }
    ...
    public static String[] getMobListForTheme(CometTier tier, String themeId) {
        ...
        int tierNum = getTierNumber(tier);
        return theme.getMobIdsForTier(tierNum, RANDOM);
    }
    ...
    public static List<String> getBossesForTheme(CometTier tier, String themeId) {
        ...
        int tierNum = getTierNumber(tier);
        return theme.getBossIdsForTier(tierNum, RANDOM);
    }
    ...
    public static long getTimeoutMillis(CometTier tier) {
        ...
        return config.getWaveTimeoutMillis();
    }
    ...
    public static double[] getSpawnRadius(CometTier tier) {
        CometConfig config = CometConfig.getInstance();
        if (config == null) {
            return new double[] { 2.0, 8.0 };
        }
        return config.getWaveSpawnRadiusRange();
    }
    ...
    public static boolean isThemeAvailableForTier(String themeId, CometTier tier) {
        ...
        int tierNum = getTierNumber(tier);
        Map<String, Integer> pool = config.getResolvedThemePool(tierNum);
        return pool.getOrDefault(themeId, 0) > 0;
    }
    ...
    public static float[] getBossStatMultipliers(String themeId, CometTier tier, String bossId, int zoneLevel) {
        ...
        return theme.getBossMultipliers(getTierNumber(tier), bossId);
    }
    ...
    public static float[] getMobStatMultipliers(String themeId, CometTier tier, String baseMobId, int zoneLevel) {
        ...
        return theme.getMobMultipliers(getTierNumber(tier), baseMobId);
    }
    ...
    public static int getNormalWaveCount(String themeId) {
        ...
        return theme.getNormalWaveCount();
    }
    ...
    public static String[] getMobListForWave(CometTier tier, String themeId, int waveIndex) {
        ...
        int tierNum = getTierNumber(tier);
        return wave.getMobIdsForTier(tierNum, RANDOM);
    }
    ...
    public static List<String> getBossesForWave(CometTier tier, String themeId, int waveIndex) {
        ...
        int tierNum = getTierNumber(tier);
        return wave.getBossIdsForTier(tierNum, RANDOM);
    }
