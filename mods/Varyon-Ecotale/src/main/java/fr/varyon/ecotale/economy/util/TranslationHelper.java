...
public class TranslationHelper {
    ...
    public static String getServerLanguage() {
        ...
        if (lang == null) {
            lang = VaryonEcotalePlugin.getInstance().getEconomyConfig().getLanguage();
    ...
    public static String getLanguageFor(@NullableDecl PlayerRef playerRef) {
        ...
        if (playerRef == null || !VaryonEcotalePlugin.getInstance().getEconomyConfig().isUsePlayerLanguage()) {
