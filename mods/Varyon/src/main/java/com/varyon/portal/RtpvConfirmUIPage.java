    ...
    private void handleRetry(
        ...
        world.execute(() -> {
            try {
                ...
                org.joml.Vector3d hSafePos = new org.joml.Vector3d(safePos.x, safePos.y, safePos.z);
                Teleport teleport = Teleport.createForPlayer(world, hSafePos, com.hypixel.hytale.math.vector.Rotation3f.ZERO);
                store.addComponent(ref, Teleport.getComponentType(), teleport);
                FirstSpawnStyleParticleFx.playAt(world, hSafePos, ref, store,
