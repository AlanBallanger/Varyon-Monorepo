...
public class ZonesPortalPreInteractionSystem extends EntityEventSystem<EntityStore, UseBlockEvent.Pre> {

    private static final String ZONES_PORTAL_BLOCK_ID = "Varyon_Portal_Zones";

    public ZonesPortalPreInteractionSystem() {
    ...
    public void handle(int index, @Nonnull ArchetypeChunk<EntityStore> archetypeChunk,
        ...
        if (!blockType.getId().contains(ZONES_PORTAL_BLOCK_ID)) return;
