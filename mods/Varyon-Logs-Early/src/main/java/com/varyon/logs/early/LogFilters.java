...
public final class LogFilters {
    ...
    private static final Pattern[] BASE_GAME_PATTERNS = compile(
        ...
        "\\[NPC\\|P\\] Unknown JSON attribute '[^']+' found in Role\\|(Variant|Abstract):.+",
        "\\[I18nModule\\|P\\] Loaded \\d+ entries for '[^']+' from /Server/Languages",
        "\\[NPC\\|P\\] Replacing asset '[^']+' of file '.+' with other file '.+'",
        "(?s)\\[AssetStore\\|Item\\] Failed to validate asset!.*?WARNING: \\[LOC\\] Key '[^']+' does not exist in server\\.lang!",
        "\\[ItemModule\\|P\\] Computed damage data for \\d+ of \\d+ weapon items"
    );
    ...
    private static final Pattern[] MOD_PATTERNS = compile(
        ...
        "\\[Alec's Tamework!\\|P\\] Loaded Tamework language entries from (archive|mod): .+",
        "\\[EnchantmentRegistry\\] Registered enchantment: .+",
        "\\[LanguageManager\\] Loaded translation file for: .+",
        "\\[SimpleEnchanting\\] Registered .+",
        "\\[MailManager\\] \\[EssentialsPlus\\] Loaded mailbox for player: .+",
        "\\[Languages\\] \\[EssentialsPlus\\] (Updated language file with new keys|Loaded language(?! override)|Validated override\\.lang|Loaded language override).*",
        "\\[KitsManager\\] \\[EssentialsPlus\\] Loaded kit: .+",
        "\\[EssentialsPlus\\] \\[EssentialsPlus\\] (Registered VanishVisibilitySystem|Position Tracker started|.+ system (enabled|disabled|initialized))"
    );
