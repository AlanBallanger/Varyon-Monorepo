...
public enum PlayerSpecialization {
    ...
    REMPART  ("rempart",   "Rempart",           PlayerClass.GUERRIER, "Weapon_Shield_Orbis_Knight",     "Tank - Bouclier - Protection",   "Maître de la défense et de la résilience.",      1.20, 0.85, 1.20, 1.10, 0.75, 0.75,  1.25, 0.75, 1.25, 1.00, 1.00, 1.00),
    ...
    BAGARREUR("bagarreur", "Bagarreur",         PlayerClass.BARBARE,  "Armor_Cloth_Cindercloth_Hands",  "Corps à corps - Étourdissements - Tenace","Combat brutal à mains nues ou en mêlée.", 1.15, 1.50, 1.10, 0.90, 0.80, 0.50,  1.00, 1.00, 1.00, 1.00, 0.75, 0.75),
