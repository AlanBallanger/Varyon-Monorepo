...
public final class RodeurPoisonSystem extends EntityTickingSystem<EntityStore> {

    private static final long TICK_INTERVAL_MS = 1_000L;
    private static final int  TICKS_TOTAL = (int)(RodeurPassifs.POISON_DURATION_MS / TICK_INTERVAL_MS);
    ...
    public void applyPoison(@Nonnull Ref<EntityStore> victimRef, float weaponDamage,
        ...
        float dpt = weaponDamage * RodeurPassifs.POISON_WEAPON_PCT;
