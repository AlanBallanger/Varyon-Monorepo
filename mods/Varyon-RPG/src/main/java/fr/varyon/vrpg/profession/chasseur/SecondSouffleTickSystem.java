...
public final class SecondSouffleTickSystem extends EntityTickingSystem<EntityStore> {

    private static final int CHECK_INTERVAL = 20;
    private static final String NODE_ID = "8";
    private static final String MODIFIER_KEY = "second_souffle_stamina";
    ...
    public SecondSouffleTickSystem(ProfessionManager professionManager) {
    ...
    private void applyModifier(UUID uuid, int rank,
        ...
        try {
            ...
            float multiplier = 1.0f + rank * 0.05f;
            statMap.putModifier(
