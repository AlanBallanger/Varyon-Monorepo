...
public final class ProfessionSkillTrees {
    ...
    private static final String[][] FORESTIER_TREE_NODES = {
        ...
        {"6",  "Rôdeur Sylvestre",          "Passif", "La forêt paraît moins sauvage quand on la connaît.",                "Augmente votre vitesse dans les forêts et réduit les dégâts de chute.",                                       "Jobs_Icons/Forest_Runner.png"},
