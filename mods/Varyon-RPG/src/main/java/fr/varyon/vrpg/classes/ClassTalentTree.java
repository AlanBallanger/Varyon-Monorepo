...
public final class ClassTalentTree {
    ...
    static {
        ...
        SPEC_TREES.put(PlayerSpecialization.RODEUR, new Node[]{
            ...
            new Node("Ricochet",             "Passif", "Une flèche bien tirée trouve toujours une seconde cible.",           "Les flèches normales ricochent sur une cible proche (2 cibles au rang max).",           ROI + "Ricochet.png",             5),
