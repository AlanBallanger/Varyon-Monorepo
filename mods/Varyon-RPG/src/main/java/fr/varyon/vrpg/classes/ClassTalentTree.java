...
public final class ClassTalentTree {
    ...
    static {
        ...
        SPEC_TREES.put(PlayerSpecialization.DUELLISTE, new Node[]{
            ...
            new Node("Expert en Duel",        "Passif", "Les leçons sont plus faciles à retenir quand elles ne font pas mal.",     "Gain d'expérience augmenté lorsque les PV sont supérieurs à 70 %.", DI + "Expert_En_Duel.png",         5),
            new Node("Entaille Profonde",      "Passif", "Une goutte de sang en appelle souvent une autre.",                        "Les attaques ont une chance d'infliger un saignement.",             DI + "Blessure_Ouverte.png",       5),
            new Node("Coup d'Estoc",          "Actif",  "Un duelliste prépare toujours sa prochaine attaque.",                    "Frappe en AoE autour du joueur, puis arme le prochain coup d'un multiplicateur de dégâts.", DI + "Coup_D_estoc.png", 5),
            ...
            new Node("Ascendant Tactique",     "Passif", "Un duel est plus beau sans y laisser une goutte de sang.",                "Après une parade réussie, la prochaine attaque inflige davantage de dégâts.", DI + "Contre_Attaque.png",    5),
            new Node("Feinte",                "Actif",  "La lame finit toujours par trouver son chemin.",                        "Le prochain coup ne peut être ni bloqué ni paré par l'adversaire.", DI + "Feinte.png",                 5),
            ...
            new Node("Points Vitaux",           "Passif", "Il suffit parfois d'un seul coup bien placé.",                            "Les coups critiques infligent des dégâts supplémentaires.",          DI + "Frappe_Précise.png",         5),
            new Node("Désarmement",           "Actif",  "le tintement métallique de l'arme de votre adversaire sur le sol résonne", "Réduit temporairement les dégâts infligés par la cible.",           DI + "Désarmement.png",            5),
            new Node("Momentum",              "Passif", "Frapper sans être frappé.",                                             "Chaque coup consécutif sans en recevoir augmente les dégâts.", DI + "Momentum.png",           5),
        ...
        SPEC_TREES.put(PlayerSpecialization.OMBRE, new Node[]{
            new Node("Repli Furtif",          "Actif",  "Un pas de recul, puis plus rien.",                                          "Ruée vers l'arrière suivie d'une courte invisibilité.",                              OI + "Pas_Des_Tenebres.png",      5),
            new Node("Assassinat",             "Passif", "Vite fait. Bien fait.",                                                     "Gain d'expérience augmenté si la cible est tuée en moins de 5 secondes.",            OI + "Execution_Rapide.png",      5),
            ...
            new Node("Déluge de Lames",       "Actif",  "Les coups pleuvent sans répit.",                                            "Enchaînement rapide de frappes infligeant des dégâts à la cible devant soi.",       OI + "Deluge_De_Lames.png",       5),
            new Node("Écran de Fumée",        "Actif",  "Mais t'es où ? Pas là.",                                                    "Devient invisible pendant quelques secondes, bloquant les dégâts reçus.",           OI + "Ecran_De_Fumee.png",        5),
            new Node("Effet de Surprise",     "Passif", "Votre charisme est tel qu'il paralyse vos cibles.",                          "La première attaque après une invisibilité immobilise brièvement la cible.",         OI + "Embuscade.png",             5),
            ...
            new Node("Traversée Obscure",      "Actif",  "Une simple question d'angle mort…",                                        "Se téléporte derrière la cible et frappe. Bonus si la cible est à moins de 30 % PV.", OI + "Pas_De_L_Ombre.png",      5),
            new Node("Instinct de Survie",    "Passif", "Le danger aiguise les sens.",                                              "Sous 30 % de points de vie, les chances d'esquive sont fortement augmentées.",       OI + "Instict_De_Survie.png",     5),
            new Node("Verrouillage Mortel",    "Actif",  "Toi, je t'aime vraiment pas.",                                              "Marque une cible : toutes les attaques contre elle sont des coups critiques.",       OI + "Chasse_Ouverte.png",        5),
        });
        ...
        SPEC_TREES.put(PlayerSpecialization.BAGARREUR, new Node[]{
            ...
            new Node("Garde du Boxeur",      "Passif", "La meilleure défense, c'est de voir venir le coup.",                          "Réduit les dégâts reçus lorsque l'attaquant est face à vous.",                               FI + "Garde_Du_Boxeur.png",            5),
            ...
            new Node("Esprit Combatif",      "Passif", "Le danger aiguise ses sens.",                                                 "Inflige davantage de dégâts lorsque les points de vie de l'adversaire sont inférieurs à 50 %.", FI + "Esprit_Combatif.png",            5),
            ...
            new Node("Adrénaline",           "Passif", "La douleur est un carburant.",                                                "Recevoir des dégâts accorde un bonus de vitesse cumulable. Chaque nouveau coup reçu pendant la durée du buff réinitialise le délai et ajoute un cumul (max 3).", FI + "Adrénaline.png",                 5),
            ...
            new Node("Acharnement",          "Passif", "Chaque coup porte un peu plus que le précédent.",                             "Les dégâts augmentent à chaque frappe sur la même cible (max 5 cumuls).",                    FI + "Acharnement.png",                5),
        });
        ...
        SPEC_TREES.put(PlayerSpecialization.GARDIEN_DE_GAIA, new Node[]{
            ...
            new Node("Grâce de Gaïa",        "Passif", "Gaïa donne plus à ceux qui en ont le plus besoin.",                      "Les soins sont plus efficaces sur les cibles sous 40% PV.",                                  GGI + "Grace_De_Gaia.png",              5),
        ...
        SPEC_TREES.put(PlayerSpecialization.ARCANISTE, new Node[]{
            ...
            new Node("Nova de Givre",       "Actif",  "Le froid jaillit de lui comme une explosion silencieuse.",             "Inflige des dégâts aux ennemis proches et les gèle sur place.",                             AI + "Nova_De_Givre.png",        5),
        ...
        SPEC_TREES.put(PlayerSpecialization.RODEUR, new Node[]{
            ...
            new Node("Ricochet",             "Passif", "Une flèche bien tirée trouve toujours une seconde cible.",           "Les flèches normales ricochent sur une cible proche (2 cibles à partir du rang 4).",    ROI + "Ricochet.png",             5),
            ...
            new Node("Piège Entravant",      "Actif",  "Un piège discret suffit à clouer un ennemi sur place.",              "Pose un piège au sol qui immobilise les ennemis passant dessus.",                       ROI + "Piège_A_Loup.png",         5),
            new Node("Foulée du Rodeur",     "Passif", "Chaque flèche décochée le pousse à avancer.",                       "Augmente la vitesse de déplacement après un tir de flèche normale.",                     ROI + "Foulée_Du_Rodeur.png",     5),
        ...
        SPEC_TREES.put(PlayerSpecialization.ARBALETRIER, new Node[]{
            ...
            new Node("Chasseur de Colosses", "Passif", "Plus la proie est grande, plus la chasse est belle.",                "Inflige plus de dégâts aux ennemis ayant plus de points de vie que vous.",                                                        ABI + "Chasseur_De_Colosses.png", 5),
            ...
            new Node("Carreau Transperçant", "Actif",  "L'armure ne fait que ralentir ce qui est inévitable.",               "Tire un carreau qui traverse tous les ennemis sur sa trajectoire et ralentit fortement les cibles.",                                 ABI + "Carreau_Transpercant.png", 5),
            new Node("Carreaux Lacérants",   "Passif", "Chaque carreau laisse une marque qui saigne.",                       "Les carreaux appliquent un saignement.",                                                                                             ABI + "Carreau_Lacérant.png",     5),
            new Node("Viseur Expérimenté",   "Passif", "Plus la cible est loin, plus le tir est précis.",                    "Les dégâts augmentent plus la cible est éloignée (max 30m).",                                                                       ABI + "Viseur_Expérimenté.png",   5),
            new Node("Tireur Embusqué",      "Passif", "L'immobilité est une arme.",                                         "Les dégâts augmentent après 3 secondes d'immobilité.",                                                                              ABI + "Tireur_Embusqué.png",      5),
        ...
        SPEC_TREES.put(PlayerSpecialization.LANCIER, new Node[]{
            ...
            new Node("Garde du Lancier",      "Actif",  "Un instant de calme avant la tempête.",                               "Adopte une posture défensive. La prochaine attaque reçue est annulée et arme un coup dévastateur.", LCI + "Garde_Du_Lancier.png", 5),
        ...
        SPEC_TREES.put(PlayerSpecialization.REMPART, new Node[]{
            new Node("Bélier",                 "Actif",  "Yippee Ki-Yay !",                                                            "Charge en ligne droite en repoussant et frappant les ennemis sur le passage.",     RI + "Charge_Lourde.png",         5),
            new Node("Protecteur",             "Passif", "On comprend la valeur d'un bouclier quand il vient à manquer.",             "Gain d'expérience de classe augmenté lorsqu'un bouclier est équipé.",               RI + "Maitre_Du_Bouclier.png",     5),
            new Node("Santé de Fer",           "Passif", "C'est peut-être les épinards ?",                                            "Augmente les points de vie maximum.",                                               RI + "Constitution_De_Fer.png",    5),
            ...
            new Node("Forteresse",            "Actif",  "Il va falloir frapper plus fort que ça.",                                   "Réduit massivement les dégâts reçus pendant quelques secondes.",                    RI + "Forteresse.png",             5),
            new Node("Garde Impénétrable",    "Passif", "Bloquer, c'est l'essence même du rempart.",                                 "Après un blocage réussi, les dégâts reçus sont réduits pendant quelques secondes.", RI + "Garde_Impénétrable.png",     5),
            new Node("Second Souffle",        "Actif",  "Le corps cache parfois bien ses réserves.",                                 "Restaure instantanément une partie des points de vie.",                             RI + "Second_Souffle.png",         5),
            ...
            new Node("Riposte",                "Passif", "Il n'avait qu'à pas commencer.",                                            "Après un blocage réussi, la prochaine attaque inflige davantage de dégâts.",        RI + "Contre_Offensif.png",        5),
            new Node("Provocation",           "Actif",  "Puis-je avoir votre attention s'il vous plaît ?",                           "Force les ennemis proches à t'attaquer pendant quelques secondes.",                 RI + "Provocation.png",            5),
            new Node("Dernier Bastion",       "Passif", "La solidité du corps se révèle dans l'adversité.",                         "Sous 30 % de points de vie, subis moins de dégâts.",                               RI + "Dernier_Bastion.png",        5),
