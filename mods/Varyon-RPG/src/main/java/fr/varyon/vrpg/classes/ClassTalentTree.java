...
public final class ClassTalentTree {
    ...
    static {
        ...
        final String ROI = "Classes_Icons/Rodeur/";
        SPEC_TREES.put(PlayerSpecialization.RODEUR, new Node[]{
            new Node("Recul Stratégique",    "Actif",  "Fuir n'est pas une faiblesse — c'est une tactique.",                 "Ruée vers l'arrière puis gagne temporairement de la vitesse.",                          ROI + "Recul_Strategique.png",    5),
            ...
            new Node("Pluie de Flèches",     "Actif",  "Quand une flèche ne suffit pas, le ciel en envoie une douzaine.",    "Bombarde une zone de projectiles pendant quelques secondes.",                           ROI + "Pluie_De_Fleches.png",     5),
            ...
            new Node("Flèche de Recul",      "Actif",  "Parfois, créer de la distance vaut mieux que d'avancer.",            "Tire une flèche qui repousse fortement la cible.",                                      ROI + "Fleche_De_Recul.png",      5),
            new Node("Flèche Entravante",    "Actif",  "Une flèche au bon endroit cloue les pieds au sol.",                  "Tire une flèche qui immobilise brièvement la cible.",                                   ROI + "Fleche_Entravante.png",    5),
            new Node("Flèches Toxiques",     "Passif", "Chaque égratignure laisse une trace invisible.",                     "Les attaques ont une chance d'empoisonner la cible.",                                   ROI + "Fleches_Toxiques.png",     5),
            ...
            new Node("Précision Mortelle",   "Passif", "Les blessés tombent plus vite.",                                     "Inflige plus de dégâts aux ennemis ayant moins de 50 % de PV.",                        ROI + "Precision_Mortelle.png",   5),
        ...
        final String ABI = "Classes_Icons/Arbaletrier/";
        SPEC_TREES.put(PlayerSpecialization.ARBALETRIER, new Node[]{
            ...
            new Node("Tireur d'Élite",       "Passif", "La portée, c'est l'avantage.",                                       "Gain d'expérience augmenté lorsque la cible est à plus de 15 mètres.",                 ABI + "Tireur_Elite.png",         5),
            ...
            new Node("Carreau Transperçant", "Actif",  "L'armure ne fait que ralentir ce qui est inévitable.",               "Tire un carreau qui traverse les ennemis et ralentit fortement les cibles.",            ABI + "Carreau_Transpercant.png", 5),
            new Node("Coup de Botte",        "Actif",  "Quand le carreau est rechargé, le pied parle.",                      "Coup de pied violent qui repousse les adversaires.",                                    ABI + "Coup_De_Botte.png",        5),
            new Node("Chasseur de Colosses", "Passif", "Plus la proie est grande, plus la chasse est belle.",                "Inflige davantage de dégâts aux ennemis ayant plus de HP que soi.",                    ABI + "Chasseur_Colosses.png",    5),
            new Node("Tireur Embusqué",      "Passif", "L'immobilité est une arme.",                                         "Les dégâts augmentent après quelques secondes d'immobilité.",                          ABI + "Tireur_Embusque.png",      5),
            new Node("Ancrage",              "Passif", "Immobile comme un rocher sous les coups.",                           "Réduit les dégâts reçus tant que le personnage reste immobile.",                        ABI + "Ancrage.png",              5),
            new Node("Carreaux Lacérants",   "Passif", "Chaque carreau laisse une marque qui saigne.",                       "Les attaques ont une chance d'infliger un saignement progressif.",                      ABI + "Carreaux_Lacerants.png",   5),
            new Node("Réflexes Affûtés",     "Passif", "Son instinct le fait bouger avant même qu'il décide.",               "Augmente les chances d'esquive et les dégâts selon la distance.",                      ABI + "Reflexes_Affutes.png",     5),
            new Node("Mise en Joue",         "Actif",  "Prendre le temps d'ajuster — pour ne jamais manquer.",               "Prochaine attaque garantie critique avec des dégâts considérablement augmentés.",      ABI + "Mise_En_Jou.png",          5),
        });
