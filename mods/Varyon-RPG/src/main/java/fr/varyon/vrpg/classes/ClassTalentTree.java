...
public final class ClassTalentTree {
    ...
    static {
        ...
        SPEC_TREES.put(PlayerSpecialization.GARDIEN_DE_GAIA, new Node[]{
            ...
            new Node("Grâce de Gaïa",        "Passif", "Gaïa donne plus à ceux qui en ont le plus besoin.",                      "Les soins sont plus efficaces sur les cibles sous 40% HP.",                                  GGI + "Grace_De_Gaia.png",              5),
