...
public final class AssautBestialSkill {

    public static final String SKILL_ID       = "assaut_bestial";
    public static final String TALENT_NODE_ID = "berserker_0";

    private static final double[] DASH_DISTANCE = {5.0, 6.0, 7.0, 8.0, 10.0};
    private static final float[]  DAMAGE_PCT    = {0.8f, 1.0f, 1.2f, 1.5f, 1.8f};
