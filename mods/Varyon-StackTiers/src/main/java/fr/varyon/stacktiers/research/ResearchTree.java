...
public final class ResearchTree {
    ...
    public static final List<ResearchNode> NODES = List.of(
        new ResearchNode("soil_1", "soil", 1, 0, 1, List.of("rock_1", "wood_1"), "Soil_Dirt", 500, 2100000L),
        new ResearchNode("soil_2", "soil", 2, 0, 5, List.of("rock_2", "wood_2", "soil_1"), "Soil_Dirt", 1250, 14400000L),
        new ResearchNode("soil_3", "soil", 3, 0, 9, List.of("rock_3", "wood_3", "soil_2"), "Soil_Dirt", 3125, 25200000L),
        new ResearchNode("wood_1", "wood", 1, 1, 0, List.of(), "Wood_Ash_Trunk", 500, 2400000L),
        new ResearchNode("wood_2", "wood", 2, 1, 4, List.of("wood_1", "ingredient_1"), "Wood_Ash_Trunk", 1250, 13500000L),
        new ResearchNode("wood_3", "wood", 3, 1, 8, List.of("wood_2", "ingredient_2"), "Wood_Ash_Trunk", 3125, 39600000L),
        new ResearchNode("rock_1", "rock", 1, 0, 0, List.of(), "Rock_Stone", 500, 3000000L),
        new ResearchNode("rock_2", "rock", 2, 0, 4, List.of("rock_1", "metal_1"), "Rock_Stone", 1250, 8100000L),
        new ResearchNode("rock_3", "rock", 3, 0, 8, List.of("rock_2", "metal_2"), "Rock_Stone", 3125, 37800000L),
        new ResearchNode("plant_1", "plant", 1, 2, 1, List.of("fish_1", "cloth_1"), "Plant_Crop_Carrot_Item", 200, 1800000L),
        new ResearchNode("plant_2", "plant", 2, 2, 5, List.of("fish_2", "cloth_2", "plant_1"), "Plant_Crop_Carrot_Item", 500, 13500000L),
        new ResearchNode("plant_3", "plant", 3, 2, 9, List.of("fish_3", "cloth_3", "plant_2"), "Plant_Crop_Carrot_Item", 1250, 28800000L),
        new ResearchNode("cloth_1", "cloth", 1, 3, 0, List.of(), "Ingredient_Fabric_Scrap_Linen", 50, 3000000L),
        new ResearchNode("cloth_2", "cloth", 2, 3, 4, List.of("cloth_1", "potion_1"), "Ingredient_Fabric_Scrap_Shadoweave", 150, 9900000L),
        new ResearchNode("cloth_3", "cloth", 3, 3, 8, List.of("cloth_2", "potion_2"), "Ingredient_Fabric_Scrap_Cindercloth", 250, 27000000L),
        new ResearchNode("ingredient_1", "ingredient", 1, 1, 2, List.of("wood_1", "soil_1", "plant_1"), "Ingredient_Crystal_Blue", 100, 3300000L),
        new ResearchNode("ingredient_2", "ingredient", 2, 1, 6, List.of("wood_2", "soil_2", "plant_2", "ingredient_1"), "Ingredient_Crystal_Blue", 250, 13500000L),
        new ResearchNode("ingredient_3", "ingredient", 3, 1, 10, List.of("wood_3", "soil_3", "plant_3", "ingredient_2"), "Ingredient_Crystal_Blue", 625, 36000000L),
        new ResearchNode("fish_1", "fish", 1, 2, 0, List.of(), "Fish_Catfish_Item", 50, 3600000L),
        new ResearchNode("fish_2", "fish", 2, 2, 4, List.of("fish_1", "food_1"), "Fish_Catfish_Item", 125, 14400000L),
        new ResearchNode("fish_3", "fish", 3, 2, 8, List.of("fish_2", "food_2"), "Fish_Catfish_Item", 312, 34200000L),
        new ResearchNode("food_1", "food", 1, 2, 3, List.of("plant_1", "ingredient_1", "furniture_1"), "Food_Bread", 15, 2700000L),
        new ResearchNode("food_2", "food", 2, 2, 7, List.of("plant_2", "ingredient_2", "furniture_2", "food_1"), "Food_Bread", 150, 9000000L),
        new ResearchNode("food_3", "food", 3, 2, 11, List.of("plant_3", "ingredient_3", "furniture_3", "food_2"), "Food_Bread", 1200, 27000000L),
        new ResearchNode("potion_1", "potion", 1, 3, 3, List.of("furniture_1"), "Potion_Health", 15, 3300000L),
        new ResearchNode("potion_2", "potion", 2, 3, 7, List.of("furniture_2", "potion_1"), "Potion_Health", 150, 9000000L),
        new ResearchNode("potion_3", "potion", 3, 3, 11, List.of("furniture_3", "potion_2"), "Potion_Health", 1200, 36000000L),
        new ResearchNode("metal_1", "metal", 1, 0, 3, List.of("soil_1", "ingredient_1"), "Ingredient_Bar_Iron", 100, 2700000L),
        new ResearchNode("metal_2", "metal", 2, 0, 7, List.of("soil_2", "ingredient_2", "metal_1"), "Ingredient_Bar_Iron", 250, 7200000L),
        new ResearchNode("metal_3", "metal", 3, 0, 11, List.of("soil_3", "ingredient_3", "metal_2"), "Ingredient_Bar_Iron", 625, 39600000L),
        new ResearchNode("furniture_1", "furniture", 1, 3, 2, List.of("cloth_1", "plant_1"), "Furniture_Ancient_Chest_Small", 20, 3600000L),
        new ResearchNode("furniture_2", "furniture", 2, 3, 6, List.of("cloth_2", "plant_2", "furniture_1"), "Furniture_Ancient_Chest_Small", 200, 8100000L),
