...
final class PlayerMarkerJson {

    private final Map<String, String> values;

    private PlayerMarkerJson(Map<String, String> values) {
        this.values = values;
    }

    static PlayerMarkerJson parseObject(String json) {
        if (json == null) {
            throw new IllegalArgumentException("JSON content is missing");
        }
        Parser parser = new Parser(json);
        return new PlayerMarkerJson(parser.parseObject());
    }
