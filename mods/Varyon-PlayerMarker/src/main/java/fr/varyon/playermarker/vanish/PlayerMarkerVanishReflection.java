...
final class PlayerMarkerVanishReflection {

    private static final ClassLoader CLASS_LOADER = PlayerMarkerVanishReflection.class.getClassLoader();

    private PlayerMarkerVanishReflection() {}
