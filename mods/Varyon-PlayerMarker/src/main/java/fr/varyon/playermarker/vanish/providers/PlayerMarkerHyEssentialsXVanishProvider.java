...
final class PlayerMarkerHyEssentialsXVanishProvider implements PlayerMarkerVanishProvider {
    ...
    private Object findHyEssentialsPlugin() {
        try {
            return PlayerMarkerVanishReflection.resolveEnabledPluginInstance(
                    PLUGIN_CLASS_NAME,
                    PLUGIN_IDENTIFIER,
                    PLUGIN_GETTER);
    ...
    private Object resolveManagerFromStaticPlugin() {
        try {
            Class<?> pluginClass = PlayerMarkerVanishReflection.loadClass(PLUGIN_CLASS_NAME, null);
            if (pluginClass == null) {
                return null;
            }
            Object plugin = PlayerMarkerVanishReflection.invokeStaticNoArgs(pluginClass, PLUGIN_GETTER);
